...
namespace Buffers
{
    ...
    ZBuffer::ZBuffer() : GSbuffer(), enable(true), method(ZbufferTestMethod::GREATER_EQUAL), zbufferStorageMethod(GSZbufferStorageMethodEnum::ZBUF_24)
    {
    ...
    unsigned int ZBuffer::AllocateVRAMForBuffer()
    {
        return graph_vram_allocate(this->width, this->height, static_cast<int>(this->zbufferStorageMethod), GRAPH_ALIGN_PAGE);
    }
