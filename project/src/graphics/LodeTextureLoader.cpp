...
std::shared_ptr<unsigned char> LODETextureLoader::GetBytes(const char *image_path,
                                                           int &width,
                                                           int &height,
                                                           int &nrChannels)
{
    ...
    height = Uheight;
    auto ptr =
        std::shared_ptr<unsigned char>(new unsigned char[tempImgData.size()], std::default_delete<unsigned char[]>());
