...
void Texture::SetTextureAsActive()
{
    ...
    qword.dw[0] = ((u64(this->gsTextureBuffer->GetVramAddress()) >> 6) & 0x3fff) | (((u64(width) >> 6) & 0x3f) << 14) | ((u64(Buffers::GSPixelStorageMethod::PSM_24) & 0x3f) << 20) | ((u64(draw_log2(width)) & 0xf) << 26) | ((u64(draw_log2(height)) & 0xf) << 30) | ((u64(0) & 0x1) << 34) | // RGB or RGBA
...
void Texture::LoadTexture(std::shared_ptr<ITextureLoader> textureLoader)
{
